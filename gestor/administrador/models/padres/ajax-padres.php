        ...
        if ($result) {
            ...
            if (empty($idpadre)) {
                ...
                if (empty($contraseña)) {
                    ...
                    $request = $queryUpdate->execute(array($nombre, $apellido_paterno, $apellido_materno, $nombre_usuario, $numero_contacto, $id_rol, $info_contacto, $est_reg, $idpadre));
                    $accion = 2;
                } else {
                    ...
                    $queryUpdate = $pdo->prepare($sqlUpdate);
                    $request = $queryUpdate->execute(array($nombre, $apellido_paterno, $apellido_materno, $nombre_usuario, $contraseña, $numero_contacto, $id_rol, $info_contacto, $est_reg, $idpadre));
                    $accion = 3;
                }
            }
