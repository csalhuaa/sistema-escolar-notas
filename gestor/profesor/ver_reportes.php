...
// Obtener los reportes del estudiante para el curso seleccionado
$sql = "
SELECT 
    r.fecha,
    r.observaciones,
...
WHERE 
    r.id_estudiante = ? AND r.id_curso = ?
ORDER BY 
    r.fecha DESC
";
$query = $pdo->prepare($sql);
$query->execute([$id_estudiante, $id_curso]);
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-bordered">
                            ...
                            <tbody>
                                ...
                                <?php } else { ?>
                                    <tr>
                                        <td colspan="3" class="text-center">No hay reportes para este curso.</td>
                                    </tr>
                                <?php } ?>
                            </tbody>
                        </table>
